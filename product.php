    ...
    <section class="section all-products" id="products">
        <div class="top container">
            ...
            <form>
                ...
                <div class="navbar">
                    <ul>
                        <li><a href="Categorie_habit/survetement_veste.php" class="a_parent">
                            <div class="wrap">
                                <span class="icon">
                        ...
                        <li><a href="#" class="a_parent">
                            ...
                            <div class="dd_menu">
                                <ul>
                                    <li>
                                        <a href="Categorie_habit/echarpe.php" class="dd_menu_a">
                                            <div class="wrap">
                                                <span class="icon">
                                    ...
                                    <li>
                                        ...
                                        <div class="dd_submenu">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="Categorie_habit/accessoires.php">
                                                        <div class="wrap">
                                                            <span class="icon">
                                                            <i class="fas fa-biking" aria-hidden="true"></i>
                                                            </span>
                        ...
                        <li><a href="Categorie_habit/t_shirt.php" class="a_parent">
                            <div class="wrap">
                                <span class="icon">
